...
public interface ISchedulingRepository extends JpaRepository<SchedulingEntity, Long>, ISchedulingRepositoryCustom {
	...
	public List<SchedulingEntity> findByDayAndEmployee( Date dateI, Date dateF, Long employeeId );
	...
	public List<SchedulingEntity> findByWasRepetitionAndHour( Date initialDate, Long clientId, Long employeeId );
	...
	@Query( "select s from SchedulingEntity s WHERE s.client.id = ?1 " )
